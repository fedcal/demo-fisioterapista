...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/demo-fisioterapista
...
```bash
git clone https://github.com/fedcal/demo-fisioterapista.git
cd demo-fisioterapista
npm install
npm start
# → http://localhost:4200
```
...
- [GitHub repo](https://github.com/fedcal/demo-fisioterapista)
