...
hero:
  name: "Demo Studio Fisioterapista"
  text: "Template Angular 21 SSR"
  tagline: "Sito vetrina pre-configurato con dati mock realistici per PMI italiane"
  actions:
    - theme: brand
      text: Demo live
      link: https://fisioterapista.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-fisioterapista
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Studio Fisioterapista.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Studio Fisioterapista** in Italia.
...
Il mercato italiano delle PMI per **Studio Fisioterapista** ha caratteristiche specifiche:
...
```bash
git clone https://github.com/fedcal/federico-demo-fisioterapista.git
cd federico-demo-fisioterapista
npm install
npm start
# → http://localhost:4200
```
...
```bash
npm run build
npm run serve:ssr:fisioterapista
# → http://localhost:4000
```
...
- [GitHub repo](https://github.com/fedcal/federico-demo-fisioterapista)
