...
URL: `https://fisioterapista.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `fisioterapista.demo.federicocalo.dev`
...
- Output directory: `dist/fisioterapista/browser`
...
URL: `https://fedcal.github.io/federico-demo-fisioterapista/`
...
- `base: /federico-demo-fisioterapista/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `fisioterapista-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   fisioterapista-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `fisioterapista-docs.federicocalo.dev`
